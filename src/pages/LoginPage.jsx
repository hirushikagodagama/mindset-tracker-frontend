...
export default function LoginPage() {
  ...
  const handleGoogleCallback = async (response) => {
    ...
    try {
      ...
      const destination = location.state?.from?.pathname ? from : getDefaultAppRoute(result.data.user);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-bg">
      {/* Ambient blobs */}
      <div className="absolute top-[-120px] left-[-120px] w-[500px] h-[500px] rounded-full bg-accent opacity-10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-80px] right-[-80px] w-[400px] h-[400px] rounded-full bg-purple opacity-10 blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-txt2 text-sm mt-1">Welcome back</p>
        </div>
        ...
        <div className="bg-bg2 border border-white/[0.07] rounded-card p-8 shadow-2xl">
          ...
          {showGoogle ? (
            <>
              ...
              {googleLoading && (
                <p className="text-txt3 text-xs text-center mb-4">Signing in with Google…</p>
              )}
            </>
          ) : (
            <button
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-txt3 text-xs">or sign in with email</span>
            <div className="flex-1 h-px bg-white/[0.07]" />
          </div>
        ...
        <p className="text-center text-xs text-txt3 mt-6">
          ...
          <Link to="/admin/login" className="hover:text-txt2 ml-1"></Link>
        </p>
      </div>
    </div>
  );
